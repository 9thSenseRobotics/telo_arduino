#ifndef threeMotorsDriverCalypso_h
#define threeMotorsDriverCalypso_h
...
class threeMotorsDriverCalypso
{
  public:  
    // CONSTRUCTOR
    threeMotorsDriverCalypso(); // pin selection an initial config
