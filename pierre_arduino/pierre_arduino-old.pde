...
#define PwmPinMotorRight 5  //PWM control for motor outputs 1 and 2 is on digital pin 3 with ardumoto shield
#define PwmPinMotorLeft 6  //PWM control for motor outputs 3 and 4 is on digital pin 11 with ardumoto shield
